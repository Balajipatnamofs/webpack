...
class App extends Component {
  ...
  render() {
   ...
   // console.log(this.props)
    ...
    return (<Fragment><Router>
      {isAuthenticated}
    </Router>
    <Alert data={this.state.dialogData} open={this.state.open} closeDialog={(e)=>this.handleClose(e)}></Alert>
    </Fragment>
    );
  }
}
