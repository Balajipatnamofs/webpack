let data = {
  ...
  data_attributes:
    '{"file": [{"label": "Story", "file_type": "png", "data_mapping": "IMG_story"}], "plain_text": [{"label": "Desc", "max_size": "100", "min_size": "5", "data_mapping": "TX_desc"}, {"label": "Title", "max_size": "20", "min_size": "5", "data_mapping": "TX_title"}]}',
  template_data:
    '<div key={{key}} className="template template-3 d-md-flex no-gutters">\n  <div className="template-media col-md-5">\n    <img src={{IMG_story}} alt={{alt}} />\n  </div>\n  <div className="template-content col mb-4 mb-md-0">\n    <h1 className="template-title h3">{{TX_title}}</h1>\n    <p className="template-desc">{{TX_desc}}</p>\n  </div>\n</div>',
  template_desc: "Desc",
...
let data_attributes = [
  {
    ...
    type: "img",
    value:
      "https://amp.businessinsider.com/images/596ce4fa552be579088b4d50-750-422.png"
  },
  {
    label: "Desc",
    max_size: "100",
